...
public class FlatBufferBuilder {
  ...
  static final Charset utf8charset =
      Charset.forName("UTF-8"); // The UTF-8 character set used by FlatBuffers.
   ...
   * <li>Call {@link #addOffset(int)} `num_elems` number of times to set the offset of each element
   *     in the array.
   ...
   *
   * <ul>
   * <li>The call to `Monster#startMonster(FlatBufferBuilder)` will call this method with the right
